...
test.describe('Zara user journey: from cookie modal to registration', () => {
  test('TC-1 Search item by name and add all sizes', async ({ mainPage, cartPage }) => {
  ...
  test('TC-2 Remove every second item from shopping bag', async ({ mainPage, cartPage }) => {
  ...
  test('TC-3 Check the error message for incorrectly filled Email field in registration form', async ({ mainPage, cartPage, registerPage, personalDetailsPage }) => {
...
test('TC-4 Check the error message for incorrectly filled Password field in registration form', async ({ mainPage, cartPage,registerPage, personalDetailsPage }) => {
  ...
  test('TC-5 Check the error message for incorrectly filled Name field in registration form', async ({ mainPage, cartPage, registerPage, personalDetailsPage }) => {
    const itemName = 'Top';
    const minSizes = 4;
  ...
  test('TC-6 Check the error message for incorrectly filled Surname field in registration form', async ({ mainPage, cartPage, registerPage, personalDetailsPage }) => {
